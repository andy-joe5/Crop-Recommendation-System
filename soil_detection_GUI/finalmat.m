...
p = 'DOWN';
r = 'THANK YOU';
srcFiles = dir('C:\Users\ABN_01\Desktop\BIKASH_2020\Bikas\matlab_2020 -2021_code\HAND_GESTURE\4\TRAINIG_DATABASE\*.jpg'); 
for i = 1 : length(srcFiles)
   % filename = strcat('E:\2019_dip code\melo\all\',srcFiles(i).name);
   filename = strcat('C:\Users\ABN_01\Desktop\BIKASH_2020\Bikas\matlab_2020 -2021_code\HAND_GESTURE\4\TRAINIG_DATABASE\',num2str(i),'.jpg');
    I = imread(filename);
%   I1 = rgb2gray(I);
